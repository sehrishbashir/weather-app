...
function _getWeatherData(cityName) {
    ...
    // return axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=99bf340ab3242744dbfe45645c790301`)
    return axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=99bf340ab3242744dbfe45645c790301`)
}
...
function getWeather() {
    ...
    _getWeatherData(cityName)
        ...
        .then(function (response) {
            ...
            document.querySelector('#date').innerHTML = `Date: ${new Date(response.data.dt * 1000).getDate()} / ${new Date(response.data.dt * 1000).getMonth()+1} / ${new Date(response.data.dt * 1000).getFullYear()}`;
